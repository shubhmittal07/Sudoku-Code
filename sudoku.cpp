//Made By Shubh Mittal
#include<iostream>
#include<math.h>
using namespace std;

bool isSudokuSolved(int grid[9][9]){  
    for(int i=0;i<9;i++)
    {
        for(int j=0;j<9;j++)
        {
...
void dupGrid(int grid[9][9], int n){  
    int hs, vs, no=0, k=0;
    switch(n){
        case 0: hs=0; vs=0;
        break;
...
void missingInGrid(int grid[9][9], int n){ 
